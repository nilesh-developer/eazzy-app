...
const SellerPage = () => {
  ...
  const [imageUrl, setImageUrl] = useState("https://res.cloudinary.com/dodtn64kw/image/upload/v1738400740/store-banner_mxgddj.jpg");
    ...
    const fetchUserFromAPI = async () => {
      try {
        ...
        if (response.ok) {
          ...
          setImageUrl(storeData.data.banner)
        } else {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.heroSection}>
        ...
        {!image && (
          <View style={{ height: "100%", justifyContent: 'center', alignItems: 'center', backgroundColor: "#e3e3e3" }}>
            <ActivityIndicator size="large" color="#1254e8" />
          </View>
        )}
        <Image
        ...
        {store?.products?.length !== 0 ?
          <FlatList
            ...
            ListFooterComponent={isLoading ?
              <View style={{ height: 200, justifyContent: 'center', alignItems: 'center', paddingBottom: 50 }}>
                <ActivityIndicator size="large" color="#1254e8" />
              </View>
              : null}
          />
