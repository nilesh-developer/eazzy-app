...
const ForgetPasswordScreen = () => {
    ...
    const handleSendOtp = async () => {
        try {
            ...
            const response = await fetch(`${process.env.EXPO_PUBLIC_API_URL}/api/customer/send-otp`, {
                method: 'POST',
                headers: {
    ...
    const handleVerifyOtp = async () => {
        try {
            ...
            const response = await fetch(`${process.env.EXPO_PUBLIC_API_URL}/api/customer/verify-otp`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const handleUpdatePassword = async () => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.EXPO_PUBLIC_API_URL}/api/customer/reset-password`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
