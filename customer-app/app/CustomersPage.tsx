...
const CustomersPage = () => {
    ...
    const [customers, setCustomers] = useState([
        { id: '1', name: 'Alice Johnson', email: 'alice@example.com', profileImage: null },
        { id: '2', name: 'Bob Smith', email: 'bob@example.com', profileImage: null },
        { id: '3', name: 'Clara Thompson', email: 'clara@example.com', profileImage: null },
    ]);
